const flames = [
  ...
  { id: 6, w: 28,  h: 75,  bottom: 90,
    grad: "linear-gradient(to top, #ffaa00 0%, #ffee00 45%, #ffffff 80%, transparent 100%)",
    anim: "flame-c", dur: "0.28s", delay: "0.02s", blur: 0 },
];

const sparks = [
  { id: 1, left: "44%", bottom: 155, dur: "1.3s",  delay: "0s",    size: 5 },
  { id: 2, left: "56%", bottom: 160, dur: "1.6s",  delay: "0.35s", size: 4 },
  { id: 3, left: "38%", bottom: 145, dur: "1.1s",  delay: "0.7s",  size: 6 },
  { id: 4, left: "62%", bottom: 158, dur: "1.45s", delay: "0.15s", size: 3 },
  { id: 5, left: "50%", bottom: 165, dur: "1.0s",  delay: "0.9s",  size: 5 },
  { id: 6, left: "33%", bottom: 140, dur: "1.35s", delay: "0.5s",  size: 4 },
  { id: 7, left: "67%", bottom: 150, dur: "1.2s",  delay: "0.25s", size: 3 },
];

export default function SkullFire() {
  return (
    <div style={{ position: "relative", width: 300, height: 460, flexShrink: 0 }}>
      <div
        style={{
      ...
      {flames.map((f) => (
        <div
          key={f.id}
          style={{
            position: "absolute", bottom: f.bottom, left: "50%",
            marginLeft: -(f.w / 2), width: f.w, height: f.h,
      ...
      <div
        style={{
          ...
          fontSize: "8.5rem", lineHeight: 1,
          animation: "skull-glow-pulse 1.8s ease-in-out infinite",
          userSelect: "none", zIndex: 10, cursor: "default",
        }}
      >
        💀
      </div>
